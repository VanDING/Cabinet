...
export function SecretaryChat({
  ...
  return (
    <div className="flex h-full flex-col rounded-lg border border-border bg-surface-primary shadow-xs">
      {title && (
      ...
      <div className="flex gap-2 border-t border-border p-3">
        <input
          ...
          className="flex-1 rounded-lg border border-border px-3 py-2 text-sm focus:ring-2 focus:ring-accent focus:outline-hidden disabled:bg-surface-elevated"
        />
        <button
          onClick={handleSend}

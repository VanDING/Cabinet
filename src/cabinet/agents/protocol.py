...
class AgentFactory(Protocol):
    ...
    # === V0.2.0 ===
    async def assemble_employee(self, pipe_id: UUID, persona_id: UUID, team_id: UUID) -> BaseAgent: ...
    async def create_agent_from_pipe(self, pipe_id: UUID, team_id: UUID) -> BaseAgent: ...

...
describe('Auth — local app, no PIN required', () => {
  it('all local requests bypass auth', () => {
    // Cabinet is a local desktop application — no auth tokens needed
    const isLocalRequest = true;

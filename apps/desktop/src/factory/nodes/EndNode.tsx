...
export function EndNode({ data, selected }: NodeProps) {
  ...
  return (
    <div className={`flex items-center gap-2 rounded-full border-2 px-5 py-2.5 min-w-[110px] shadow-sm transition-shadow border-border wf-bg-surface-10 ${selected ? 'shadow-md ring-2 ring-border/40' : ''}`}>

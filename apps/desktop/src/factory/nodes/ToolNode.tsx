...
export function ToolNode({ data, selected }: NodeProps) {
  ...
  return (
    <>
      ...
      <div className={`flex items-center gap-1.5 rounded-md border px-3 py-2 min-w-[120px] max-w-[180px] shadow-sm transition-shadow border-border wf-bg-surface-25 ${selected ? 'shadow-md ring-2 ring-border/40' : ''}`}>

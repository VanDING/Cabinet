  ...
  return (
    <>
      <NodeToolbar isVisible={selected} position={Position.Top}>
        <span className="rounded-sm bg-surface-overlay border border-border shadow-md px-2 py-0.5 text-[10px] text-intent-info">Parallel</span>
      </NodeToolbar>
      <div className={`rounded-xl border-2 min-w-[150px] overflow-hidden shadow-xs transition-shadow wf-border-info-40 wf-bg-info-15 ${selected ? 'shadow-md ring-2 wf-ring-info-50' : ''}`}>
        ...
        <div className="px-3 py-2">
          ...
          <div className="mt-1.5 flex gap-1">
            <div className="h-1.5 flex-1 rounded-xs wf-bg-info-35" />
            <div className="h-1.5 flex-1 rounded-xs wf-bg-info-30" />
            <div className="h-1.5 flex-1 rounded-xs wf-bg-info-35" />
          </div>
        </div>

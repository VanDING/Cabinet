...
export function PassNode({ data, selected }: NodeProps) {
  ...
  return (
    <>
      ...
      <div className={`rounded-xl border-2 min-w-[130px] overflow-hidden shadow-sm transition-shadow border-border wf-bg-surface-25 ${selected ? 'shadow-md ring-2 ring-border/40' : ''}`}>

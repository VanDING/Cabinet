...
export function StartNode({ data, selected }: NodeProps) {
  ...
  return (
    <div className={`flex items-center gap-2 rounded-full border-2 px-5 py-2.5 min-w-[110px] shadow-sm transition-shadow wf-border-success-50 wf-bg-success-15 ${selected ? 'shadow-md ring-2 wf-ring-success-50' : ''}`}>

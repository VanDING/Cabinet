...
class CabinetRuntime:
    def __init__(
        ...
        # Wire pool into factory for agent reuse optimization
        if hasattr(self._agent_factory, '_pool') and self._agent_factory._pool is None:
            self._agent_factory._pool = self._agent_pool
